...
$selectservice = mysqli_query($conn, "SELECT * FROM serviceS");
					...
					<div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end"
						...
						<div class="one-forth d-flex  align-items-center ftco-animate"
							...
							<div class="text">
								...
								<h1 class="mb-4 mt-3">I'm <span>Ryan Rizki</span></h1>
						...
						<div class="col-md-12 heading-section ftco-animate">
							...
							<ul class="about-info mt-4 px-md-0 px-2">
								...
								<li class="d-flex"><span>Date of birth:</span>
									<span><?= $rowsabout['tanggal_lahir'] ?></span></li>
								<li class="d-flex"><span>Address:</span> <span><?= $rowsabout['alamat'] ?></span></li>
								<li class="d-flex"><span>Url Website:</span>
									<span><?= $rowsabout['alamat_website'] ?></span></li>
